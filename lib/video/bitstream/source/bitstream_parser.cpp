...
uint8_t solids::lib::video::bitstream::parser::core::_vps[1000];
uint8_t solids::lib::video::bitstream::parser::core::_sps[1000];
int32_t solids::lib::video::bitstream::parser::core::_vps_size = 0;
int32_t solids::lib::video::bitstream::parser::core::_sps_size = 0;

solids::lib::video::bitstream::parser::core::core(void)
{
...
void solids::lib::video::bitstream::parser::core::parse_video_parameter_set(int32_t video_codec, const uint8_t * vps, int32_t vpssize)
{
...
void solids::lib::video::bitstream::parser::core::parse_seq_parameter_set(int32_t video_codec, const uint8_t * sps, int32_t spssize, int32_t & width, int32_t & height)
{
    ::memset(_sps, 0x00, sizeof(_sps));
	removeEmulationBytes(_sps, _sps_size, (unsigned char*)sps, spssize);
	BitVector bv(_sps, 0, 8 * _sps_size);

	if (video_codec== solids::lib::video::bitstream::parser::video_codec_t::avc)
	{
	...
	else if (video_codec == solids::lib::video::bitstream::parser::video_codec_t::hevc)
	{
        unsigned i;
...
void solids::lib::video::bitstream::parser::core::profile_tier_level(BitVector & bv, unsigned max_sub_layers_minus1)
{
    bv.skipBits(96);
