		...
		namespace mf
		{
			namespace sink
			{
				...
				public:
					...
					solids::lib::mf::sink::monitor_t *	find_monitor(_In_ HMONITOR hMon);
					HRESULT								match_guid(UINT id, _Out_ DWORD * match_id);
					solids::lib::mf::sink::monitor_t &	operator[](int32_t i);
				...
				protected:
					BOOL								get_monitor_info(UINT uDevID, _Out_ solids::lib::mf::sink::monitor_t * lpmi, _In_ HMONITOR hm);
					virtual void						term_monitor_info(_Inout_ solids::lib::mf::sink::monitor_t * pmi);

				private:
					DWORD								_nmonitor;
					solids::lib::mf::sink::monitor_t	_monitor[MAX_MONITORS];
				};
				...
				{
					HWND hwnd;
					solids::lib::mf::sink::monitors * monitor_array;
